...
void DeclareFitter::setupGaus( ROOT::Fit::FitResult result, char* whichFit ){ 
  double fpar[Npar];
...
void DeclareFitter::setupTail( ROOT::Fit::FitResult resultH, char* whichFitH ){     	
  double fparH[Npar];
  double par5[10];
